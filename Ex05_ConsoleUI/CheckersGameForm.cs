...
namespace Ex05_CheckerGameForm
{
    ...
    {
        private const int k_NumberOfPlayers = 2, k_PlayerLabelHeight = 20, k_SquareLeftMargin = 20, k_SquareSize = 50;
        private const int k_InitialFirstPlayerYCordinate = 2, k_PlayerLabelYCordinate = 30;
        private const string k_CheckersName = "Checkers", k_ComputerName = "[Computer]", k_PlayerQuit = "Quit! Computer Won!";
        private const string k_AnotherRound = "Another Round?", k_Error = "Error", k_IllegalSquareChoice = "Illegal Square Choice";
        private const string k_CantQuit = "You Cant Quit", k_Draw = "Draw!", k_Win = "Win!", k_IllegalMove = "Illegal Move";
        ...
        public CheckersGameForm(
            ...
            int i_Width, 
            int i_Height,
            int i_PlayerOneXLocation,
            int i_PlayerTwoXLocation, 
